...
// src/app/app.ts
function cov_1n9dxq14ir() {
  var path = "E:\\Betto\\Suimativa3FullStack3\\FullStack3-backend\\FullStack3-backend\\fullstack3-frontend\\src\\app\\app.ts";
  var hash = "c90a7aaf5fb305ebc80b2f02629e79be3bec64c9";
  var global = new Function("return this")();
  var gcv = "__coverage__";
  var coverageData = {
    path: "E:\\Betto\\Suimativa3FullStack3\\FullStack3-backend\\FullStack3-backend\\fullstack3-frontend\\src\\app\\app.ts",
    statementMap: {
      "0": {
        start: {
          line: 6,
    ...
    inputSourceMap: {
      ...
      sources: ["app.ts"],
      names: [],
      mappings: ";;;AAAA,OAAO,EAAE,SAAS,EAAE,MAAM,EAAE,MAAM,eAAe,CAAC;AAClD,OAAO,EAAE,YAAY,EAAE,MAAM,iBAAiB,CAAC;AAQxC,IAAM,GAAG,GAAT,MAAM,GAAG;IACK,KAAK,GAAG,MAAM,CAAC,qBAAqB,CAAC,CAAC;CAC1D,CAAA;AAFY,GAAG;IANf,SAAS,CAAC;QACT,QAAQ,EAAE,UAAU;QACpB,OAAO,EAAE,CAAC,YAAY,CAAC;QACvB,8BAAyB;;KAE1B,CAAC;GACW,GAAG,CAEf",
      sourcesContent: ["import { Component, signal } from '@angular/core';\r\nimport { RouterOutlet } from '@angular/router';\r\n\r\n@Component({\r\n  selector: 'app-root',\r\n  imports: [RouterOutlet],\r\n  templateUrl: './app.html',\r\n  styleUrl: './app.scss'\r\n})\r\nexport class App {\r\n  protected readonly title = signal('fullstack3-frontend');\r\n}\r\n"]
    },
    _coverageSchema: "1a1c01bbd47fc00a2c39e90264f33305004495a9",
    hash: "c90a7aaf5fb305ebc80b2f02629e79be3bec64c9"
  };
...
var init_app3 = __esm({
  "src/app/app.ts"() {
    ...
    cov_1n9dxq14ir().s[0]++;
    App = class App2 {
      title = (cov_1n9dxq14ir().s[1]++, signal("fullstack3-frontend"));
    };
    cov_1n9dxq14ir().s[2]++;
...
var require_app_spec = __commonJS({
  "src/app/app.spec.ts"(exports) {
    ...
    describe("App", () => {
      ...
      it("deber\xEDa tener el t\xEDtulo correcto como se\xF1al", () => {
        const fixture = TestBed.createComponent(App);
        const app = fixture.componentInstance;
        expect(app["title"]()).toBe("fullstack3-frontend");
      });
      it("deber\xEDa renderizar el router-outlet", () => {
        const fixture = TestBed.createComponent(App);
